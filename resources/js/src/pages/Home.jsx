        ...
        <div>
            <main className="flex flex-col items-center justify-center mt-32">
                ...
                <section className="flex flex-wrap items-center -mx-3 font-sans px-4 mx-auto w-full lg:max-w-screen-lg sm:max-w-screen-sm md:max-w-screen-md pb-20">
                    ...
                    {/* <!-- Column-2 --> */}
                    <div className="px-3 mb-12 w-full lg:mb-0 lg:w-3/5 md:pt-10 sm:pt-5">
                ...
                <section
                    ...
                    bg-[url(https://images.unsplash.com/photo-1607703703520-bb638e84caf2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80)]"
                >
                    <h1 className="text-black text-5xl font-semibold mt-20 mb-10">
                        Get Report
                    </h1>

                    <span className="text-center font-bold my-20 text-gray-950/90">
                        <a
                            href=""
                            target="_blank"
                            className="text-gray-950/90 hover:text-gray-950/30"
                        >
                            Amazon Source
                        </a>
                ...
                <section className="p-20 space-y-8">
                    ...
                    <p>
                        Exercitation non Lorem exercitation tempor amet ad esse
                        velit. Anim deserunt id nulla quis ex magna culpa
                        exercitation. Mollit consequat enim eiusmod cupidatat
                        commodo eiusmod nulla. Id quis amet incididunt cillum
                        dolore consectetur nulla incididunt laborum excepteur
                        consectetur consectetur sunt tempor. Minim fugiat sint
                        sunt ad elit laboris est sit est laboris labore do
                        velit. Cillum aliquip pariatur deserunt eiusmod.
                        Consequat irure nulla adipisicing deserunt culpa. Veniam
                        enim deserunt sint consequat labore. Enim ullamco ea
                        aute duis et nostrud voluptate fugiat consectetur et
                        velit cillum anim dolore. In exercitation proident
